// Asegura acceso a h() para las vistas (Decap expone window.h)
const h = window.h;

/* Utilidad para leer datos con fallback */
...
const PaginaPreview = ({ entry }) => {
  ...
  return h("div", {},
    ...
    h("header", { className: "header" }, [
      ...
      h("nav", { className: "nav" }, [
        h("a", {}, "SERVICIOS"), h("a", {}, "GALERÍA"),
        h("a", {}, "BARBEROS"), h("a", {}, "CONTACTO"),
    ...
    h("section", {
      className: "hero",
      style: { backgroundImage: 'url("https://i.postimg.cc/zv5DbBj8/IMG-5592.jpg")' }
    }, h("div", { className: "inner" }, [
      h("h1", {}, "DOMINA TU ESTILO."),
      h("p", {}, "Vista previa con el mismo diseño de la web.")
    ])),
...
/* Registro de plantillas en el CMS (deben coincidir con los "name:" del config.yml) */
